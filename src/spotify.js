...
export const fetchSpotifyProfile = (token) => spotifyFetch('/me', token);
export const fetchTopArtists = (token) => spotifyFetch('/me/top/artists?limit=5&time_range=medium_term', token);
export const fetchRecentlyPlayed = (token) => spotifyFetch('/me/player/recently-played?limit=10', token);
